                    ...
                    @foreach(auth()->user()->repeat_questions as $repeat_question)
                        @if($repeat_question->hard == "1")
                            <div class="card">
                                ...
                                <a href="/repeat-on/move-question-medium/{{$repeat_question->id}}">Move question to "mediums"</a>
                            </div>
                        @endif
                    @endforeach
                </div>
...
<div  class="container">   
    <div class="row justify-content-center">
        ...
        <div class="col-md-8">
            <div class="card">
                <div class="card-header"><b>Hard Questions for {{auth()->user()->name}}</b></h5></div>
                <div class="card-body">
                    @php ($i = 0)
